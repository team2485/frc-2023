...
public class RobotContainer {
  ...
  private void configureDrivetrainCommands() {
    ...
    m_driver.leftPOV().onTrue(Commands.runOnce(() -> m_visionCommands.decreaseOffset()));

    m_driver.rightPOV().onTrue(Commands.runOnce(() -> m_visionCommands.increaseOffset()));

    m_driver.a().toggleOnTrue(m_visionCommands.alignToTag());
